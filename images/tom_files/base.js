...
if (!Array.prototype.forEach) {
  Array.prototype.forEach = function(callback) {
   ...
   for (var i = 0; i < len; i++) {
      if (i in this) callback.call(arg, this[i], i, this);
    }
...
if (window.Map === undefined) {
  window.Map = new Class({
    ...
    get    : function(name)        { return this.items[name]; },
    set    : function(name, value) { this.items[name] = value; },
    delete : function(name)        { delete this.items[name]; }
  });
}
...
Carbon.Reactive = new Class({ 
  statics: {
    ...
    on: function(name, callback) {
      ...
      return instance.observe(callback, { scope: scope });
    },
    ...
    off: function(name) {
      ...
      for(var i = 0, len = instance.observers.length; i < len; i++) {
        var observer = instance.observers[i];
  ...
  observe: function(callback, options) {
    var observer = new Carbon.Observer(callback, this, options);
  ...
  unsubscribe: function(subscription) {
    this.observers.remove(subscription);
...
Carbon.Observer = new Class({
  constructor: function(callback, reactive, options) {
  ...
  fire: function(data) {
    ...
    // todo: support debouncing & throttling
...
Carbon.Timer = new Class({
  constructor: function(time, immediate) {
    this.time = time;
    this.defer = $.Deferred();
...
Carbon.Template = new Class({
  ...
  createFragmentForChildren: function() {
...
if (!String.prototype.empty) {
  String.prototype.empty = function() {
    return this === void 0 || this === null || this.length === 0;
  };
}
